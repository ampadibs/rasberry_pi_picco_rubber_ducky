...
os.system("cp src/format.uf2 /run/media/$USER/RPI-RP2/ ")

sleep(20)

print("Flashing circuit python...")
os.system("cp src/circuit_python.uf2 /run/media/$USER/RPI-RP2/ ")

sleep(20)

print("Copying libraries...")
os.system("cp -r src/lib/adafruit_hid /run/media/$USER/CIRCUITPY/lib/")

sleep(10)

print("Copying main program...")
os.system("cp src/code.py /run/media/$USER/CIRCUITPY/code.py")
...
if file == 1:
    ...
    os.system("cp src/scripts/reverse.dd /run/media/$USER/CIRCUITPY/payload.dd")
    print("Transfered Reverse Shell")
elif file == 2:
    os.system("cp src/scripts/antivaitusoff.dd /run/media/$USER/CIRCUITPY/payload.dd")
    print("Transfered Turn off Antivairus")
elif file == 3:
    input("Please modify src/scripts/extractor.dd to your needs then press enter...")
    os.system("cp src/scripts/extractor.dd /run/media/$USER/CIRCUITPY/payload.dd")
    print("Transfered Wifi Extractor\n")
elif file == 4:
    oneortwo = int(input("Please select 1 for complicated or 2 for simple: "))
    if oneortwo == 1:
        os.system("cp src/scripts/rickrollcomp.dd /run/media/$USER/CIRCUITPY/payload.dd")
    elif oneortwo == 2:
        os.system("cp src/scripts/rickrollsimple.dd /run/media/$USER/CIRCUITPY/payload.dd")
    print("Tranfered Rickroll\n")
elif file == 5:
    os.system("cp src/scripts/hacked.dd /run/media/$USER/CIRCUITPY/payload.dd")
    print("Transfered Hacked Message\n")
elif file == 6:
    input("Create your custom file src/scripts/custom.dd and press enter...")
    os.system("cp src/scripts/custom.dd /run/media/$USER/CIRCUITPY/payload.dd")
